...
| [hotel-reservation.md](hotel-reservation.md) | Inventory, double-booking, idempotency keys, saga, deliberate overbooking | core |
...
| Move | Appears in |
|---|---|
| Precompute on write vs compute on read | feed, typeahead, leaderboard, analytics |
...
| Make the mutating operation idempotent and retryable | payments, notifications, uploads, reservations |
| Serialise the contended thing, and only that thing | reservations, exchange, leaderboard |
