---
title: Courses and mock interviews
type: resource
track: universal
status: drafted
updated: 2026-09-02
...
Honest verdicts. **You do not need any of these** — you own the books and have this repo. Buy
only to fix a specific gap, and buy mocks before you buy courses.

## Paid courses

| Platform | What it is | Verdict |
|---|---|---|
...
| [Jordan Has No Life](https://www.youtube.com/@jordanhasnolife5163) (YouTube) | Free, deep, unusually rigorous | **Best free video source.** Genuinely gets into the details |
| [Arpit Bhayani](https://arpitbhayani.me/) | Free + paid, strong on internals | Excellent for storage/database depth |
| [Gaurav Sen](https://www.youtube.com/@gkcs) (YouTube) | Free, popular introductions | Fine first pass; not enough depth alone |

**If you buy exactly one thing:** buy mock interviews, not a course. You already have more
reading material than you can finish.

## Mock interviews — ranked by value
...
| Situation | Spend on |
|---|---|
| Interview in 2 weeks, rusty | 3–4 paid mocks. Nothing else |
| Interview in 2 months, new to design | Free material + this repo + weekly mocks with a friend |
| Repeatedly failing at the same stage | One targeted mock with feedback on *that* stage |
| Failing at the depth stage | No course fixes this — read DDIA ch. 5–9 and drill |
| Comfortable but want the strong-hire signal | Mocks with senior interviewers, focused on driving the conversation |
